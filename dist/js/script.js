...
/* harmony import */ var _modules_formsfetch__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./modules/formsfetch */ "./src/js/modules/formsfetch.js");
/* harmony import */ var _modules_getResourse__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./modules/getResourse */ "./src/js/modules/getResourse.js");
/* harmony import */ var _modules_simpleSlider__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./modules/simpleSlider */ "./src/js/modules/simpleSlider.js");
/* harmony import */ var _modules_smoothSlider__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./modules/smoothSlider */ "./src/js/modules/smoothSlider.js");
...
window.addEventListener('DOMContentLoaded', () => {
  ...
  Object(_modules_tabs__WEBPACK_IMPORTED_MODULE_0__["default"])('.tabcontent', '.tabheader__items', '.tabheader__item');
  Object(_modules_timer__WEBPACK_IMPORTED_MODULE_1__["default"])();
  Object(_modules_modals__WEBPACK_IMPORTED_MODULE_2__["default"])('.btn_modal-call', '.modal');
  _modules_cards__WEBPACK_IMPORTED_MODULE_3__["fitnessMenu"].addCard();
  _modules_cards__WEBPACK_IMPORTED_MODULE_3__["premiumMenu"].addCard();
  _modules_cards__WEBPACK_IMPORTED_MODULE_3__["veganMenu"].addCard(); // getResource('http://localhost:3000/menu')
  //     .then(data => {
  ...
  Object(_modules_formsfetch__WEBPACK_IMPORTED_MODULE_4__["default"])(); // simpleSlider('.offer__slide', '.offer__slider-counter', '.offer__slider-prev', '.offer__slider-next', '#current', '#total', 'offer__slide_active', 'offer__slide_hidden');

  Object(_modules_smoothSlider__WEBPACK_IMPORTED_MODULE_7__["default"])('.offer__slide', '.offer__slider-counter', '.offer__slider-prev', '.offer__slider-next', '#current', '#total', 'offer__slide_active', 'offer__slide_hidden', '.offer__slider-wrapper', '.offer__slider-inner-wrapper');
  Object(_modules_calculator__WEBPACK_IMPORTED_MODULE_8__["default"])('.calculating__result span');
});
...
/*!*********************************!*\
  !*** ./src/js/modules/cards.js ***!
  \*********************************/
/*! exports provided: default, fitnessMenu, premiumMenu, veganMenu */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "default", function() { return Cards; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "fitnessMenu", function() { return fitnessMenu; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "premiumMenu", function() { return premiumMenu; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "veganMenu", function() { return veganMenu; });
class Cards {
...
const fitnessMenu = new Cards('img/tabs/fitness.jpg', 'fit-food-img', '"Меню "Фитнес"', 'Меню "Фитнес" - это новый подход к приготовлению блюд: больше свежих овощей и фруктов. Продукт активных и здоровых людей. Это абсолютно новый продукт с оптимальной ценой и высоким качеством!', '1 749');
const premiumMenu = new Cards('img/tabs/elite.jpg', 'premium-food-img', 'Меню "Премиум"', 'В меню "Премиум" мы используем не только красивый дизайн упаковки, но и качественное исполнение блюд. Красная рыба, морепродукты, фрукты - ресторанное меню без похода в ресторан!', '2 199');
const veganMenu = new Cards('img/tabs/post.jpg', 'vegeterian-food-img', '"Меню "Постное"', 'Меню "Постное" - это тщательный подбор ингредиентов: полное отсутствие продуктов животного происхождения, молоко из миндаля, овса, кокоса или гречки, правильное количество белков за счет тофу и импортных вегетарианских стейков.', '1 349');

/***/ }),

/***/ "./src/js/modules/formsfetch.js":
/*!**************************************!*\
  !*** ./src/js/modules/formsfetch.js ***!
  \**************************************/
/*! exports provided: default */
...
/* harmony default export */ __webpack_exports__["default"] = (formsfetch);

/***/ }),

/***/ "./src/js/modules/getResourse.js":
/*!***************************************!*\
  !*** ./src/js/modules/getResourse.js ***!
  \***************************************/
/*! exports provided: default */
...
/***/ "./src/js/modules/simpleSlider.js":
/*!****************************************!*\
  !*** ./src/js/modules/simpleSlider.js ***!
  \****************************************/
/*! exports provided: default */
...
/***/ "./src/js/modules/smoothSlider.js":
/*!****************************************!*\
  !*** ./src/js/modules/smoothSlider.js ***!
  \****************************************/
/*! exports provided: default */
...
/* harmony default export */ __webpack_exports__["default"] = (smoothSlider);
...
const tabs = (tabsContentSelector, triggerContainerSelector, triggerItemSelector) => {
  const tabsContent = document.querySelectorAll(tabsContentSelector),
        ...
        triggerItem = document.querySelectorAll(triggerItemSelector); //   imgItem = document.querySelectorAll('.tabcontent__img')
